...
public class LikesController(ILikesRepository likesRepository) : BaseApiController
{
    ...
    public async Task<ActionResult> ToggleLike(string targetMemberId)
    {
        ...
        // Use the method that returns a single MemberLike
    ...
    [HttpGet]
    public async Task<ActionResult<PaginatedResults<Member>>> GetMemberLikes([FromQuery] LikesParams likesParams)
    {
